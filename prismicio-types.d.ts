...
type CaseStudyDocumentDataSlicesSlice = RichTextSlice | HeroSlice;
...
/**
 * Item in *Bento → Default → Primary → Cards*
 */
export interface BentoSliceDefaultPrimaryCardsItem {
  /**
   * Title field in *Bento → Default → Primary → Cards*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.cards[].title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  title: prismic.RichTextField;

  /**
   * Body field in *Bento → Default → Primary → Cards*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.cards[].body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Cards*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.cards[].image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Cards*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.cards[].wide
   * - **Documentation**: https://prismic.io/docs/fields/boolean
   */
...
export interface BentoSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: Italic for golden text
  ...
  /**
   * Cards field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.cards[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  cards: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryCardsItem>>;
}
...
/**
 * Item in *CaseStudies → Default → Primary → Studies*
 */
export interface CaseStudiesSliceDefaultPrimaryStudiesItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Studies*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.studies[].case_study
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Studies field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.studies[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  studies: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryStudiesItem>
  >;
}
 ...
 */
export interface HeroWithCodeAndCtaSliceDefaultPrimary {
  /**
   * Heading field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  image: prismic.ImageField<never>;
   ...
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.icon
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  icon: prismic.SelectField<"gear" | "cycle" | "star">;
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  title: prismic.RichTextField;
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.button_label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  button_label: prismic.KeyTextField;
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_code_and_cta.default.primary.button_link
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  button_link: prismic.LinkField<
    string,
 ...
 *
 * - **API ID**: `default`
 * - **Description**: Hero variation with headline, code block, and card containing icon, title, description, and button.
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroWithCodeAndCtaSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<HeroWithCodeAndCtaSliceDefaultPrimary>,
  never
>;
 ...
 */
type HeroWithCodeAndCtaSliceVariation = HeroWithCodeAndCtaSliceDefault;

/**
 * Showcase Shared Slice
 *
 * - **API ID**: `hero_with_code_and_cta`
 * - **Description**: *None*
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroWithCodeAndCtaSlice = prismic.SharedSlice<
  "hero_with_code_and_cta",
  HeroWithCodeAndCtaSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryCardsItem,
      ...
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryStudiesItem,
      ...
      HeroSliceDefault,
      HeroWithCodeAndCtaSlice,
      HeroWithCodeAndCtaSliceDefaultPrimary,
      HeroWithCodeAndCtaSliceVariation,
      HeroWithCodeAndCtaSliceDefault,
      IntegrationsSlice,
